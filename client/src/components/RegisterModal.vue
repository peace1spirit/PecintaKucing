<template>
    <div class="modal fade" id="registerModal" tabindex="-1" role="dialog" aria-hidden="true" ref="registerModal">
...
export default {
    ...
    mounted() {  
        $(this.$refs.registerModal).on("hidden.bs.modal", this.doOnHidden)
    }, 
    created() {
